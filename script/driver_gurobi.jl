...
input_dir = joinpath(hem_data_dir, "runs", "empower_test")
# mkpath(input_dir)
...
utility = Utility_short(input_dir, model_data)
customers = CustomerGroup_short(input_dir, model_data)
green_developer = GreenDeveloper(input_dir, model_data)

solve_agent_problem_empower!(
    utility,
    utility_opts,
    model_data,
    customers,
...
export_file_path = "/kfs2/projects/hem/HolisticElectricityModelData.jl/runs/empower_test/cem_results"
